"""
Django settings for randomThought project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'mysite.com', 'localhost', 'programmingstories.herokuapp.com']
...
INSTALLED_APPS = [
    ...
    'accounts.apps.AccountsConfig', # App with custom authentication templates 
...
ROOT_URLCONF = 'randomThought.urls'
...
WSGI_APPLICATION = 'randomThought.wsgi.application'
...
# Enable Django to serve static files in dev
MEDIA_URL = '/media/'
